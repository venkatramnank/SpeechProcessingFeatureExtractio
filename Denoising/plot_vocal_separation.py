...
y, sr = librosa.load('Hear_test.wav', duration=120)
print(sr)
...
#print(type(S_background))
#write('foreground_train_noise.wav',22050,librosa.amplitude_to_db(S_foreground, ref=np.max))
...
librosa.output.write_wav("foreground_Hear_test.wav", new_y, sr)